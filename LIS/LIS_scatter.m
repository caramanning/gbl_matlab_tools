...
%%
y = [min(LISA.CH4_mean_nmolkg) max(LISA.CH4_mean_nmolkg)
min(LISO.CH4_mean_nmolkg) max(LISO.CH4_mean_nmolkg)
min(LISM.CH4_mean_nmolkg) max(LISM.CH4_mean_nmolkg)];

%%
x = [min(LISA.DCH4) max(LISA.DCH4)
min(LISO.DCH4) max(LISO.DCH4)
min(LISM.DCH4) max(LISM.DCH4)];

%%
y = [min(LISA.N2O_mean_nmolkg) max(LISA.N2O_mean_nmolkg)
min(LISO.N2O_mean_nmolkg) max(LISO.N2O_mean_nmolkg)
min(LISM.N2O_mean_nmolkg) max(LISM.N2O_mean_nmolkg)];

%%
x = [min(LISA.DN2O) max(LISA.DN2O)
min(LISO.DN2O) max(LISO.DN2O)
min(LISM.DN2O) max(LISM.DN2O)];

%%
y = [min(LISA.O2_umolkg) max(LISA.O2_umolkg)
min(LISO.O2_umolkg) max(LISO.O2_umolkg)
min(LISM.O2_umolkg) max(LISM.O2_umolkg)];

%%
x = [min(LISA.DO2) max(LISA.DO2)
min(LISO.DO2) max(LISO.DO2)
min(LISM.DO2) max(LISM.DO2)];
...
exportgraphics(gcf,'20250801_WLIS_TSplot_noclabel.eps','BackgroundColor','none','ContentType','vector')
%

print(gcf,'-dpdf','-vector','20250801_WLIS_TSplot_noclabel.pdf');
epsclean('20250801_WLIS_TSplot_noclabel.eps','20250801_WLIS_TSplot_noclabel_clean.eps');
