...
subplot(sp(1))
    ...
    fill(datenum(kcA),dmA,[0.5 0.5 0.5],'edgecolor','flat');
    axis ij;
...
exportgraphics(gcf, '20250720_LIS_MID4_Currents_CH4_N2O_O2_PDen_exportgraphics_colorbar.eps','ContentType','vector')
