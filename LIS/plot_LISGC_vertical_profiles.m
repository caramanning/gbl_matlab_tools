...
hold on;
i=1;
sA = find(LISA.Station==stnlist(i));
[~,sAs] = sort(LISA.Depth(sA));

sO = find(LISO.Station==stnlist(i));
[~,sOs] = sort(LISA.Depth(sO));

sM = find(LISM.Station==stnlist(i));
[~,sMs] = sort(LISA.Depth(sM));
plot(LISA.CH4_mean_nmolkg(sA(sAs)),LISA.Depth(sA(sAs)),'o-');
plot(LISO.CH4_mean_nmolkg(sO(sOs)),LISA.Depth(sO(sOs)),'o-');
plot(LISM.CH4_mean_nmolkg(sM(sMs)),LISA.Depth(sM(sMs)),'o-');
legend('Aug','Oct','May');
title(stnlist(1))
axis ij;
...
sA = find(LISA.Station==stnlist(i));
[~,sAs] = sort(LISA.Depth(sA));
ACH4(i,1:2) = [LISA.CH4_mean_nmolkg(sA(sAs(1))) LISA.CH4_mean_nmolkg(sA(sAs(end)))];
plot(LISA.CH4_mean_nmolkg(sA(sAs)),LISA.Depth(sA(sAs)),'o-');
end;
legend(stnlist);
xlabel('CH_4')
...
for i=1:8
sO = find(LISO.Station==stnlist(i));
[~,sOs] = sort(LISO.Depth(sO));
OCH4(i,1:2) = [LISO.CH4_mean_nmolkg(sO(sOs(1))) LISO.CH4_mean_nmolkg(sO(sOs(end)))];
plot(LISO.CH4_mean_nmolkg(sO(sOs)),LISO.Depth(sO(sOs)),'o-');
end;
legend(stnlist);
xlabel('CH_4')
title('Oct')
...
for i=1:8
sM = find(LISM.Station==stnlist(i));
[~,sMs] = sort(LISM.Depth(sM));
MCH4(i,1:2) = [LISM.CH4_mean_nmolkg(sM(sMs(1))) LISM.CH4_mean_nmolkg(sM(sMs(end)))];
plot(LISM.CH4_mean_nmolkg(sM(sMs)),LISM.Depth(sM(sMs)),'o-');
end;
legend(stnlist);
xlabel('CH_4')
title('May')
...
sA = find(LISA.Station==stnlist(i));
[~,sAs] = sort(LISA.Depth(sA));
AN2O(i,1:2) = [LISA.N2O_mean_nmolkg(sA(sAs(1))) LISA.N2O_mean_nmolkg(sA(sAs(end)))];
plot(LISA.N2O_mean_nmolkg(sA(sAs)),LISA.Depth(sA(sAs)),'o-');
end;
...
sO = find(LISO.Station==stnlist(i));
[~,sOs] = sort(LISO.Depth(sO));
ON2O(i,1:2) = [LISO.N2O_mean_nmolkg(sO(sOs(1))) LISO.N2O_mean_nmolkg(sO(sOs(end)))];
plot(LISO.N2O_mean_nmolkg(sO(sOs)),LISO.Depth(sO(sOs)),'o-');
end;
legend(stnlist);
xlabel('N_2O')
title('Oct')
...
for i=1:8
sM = find(LISM.Station==stnlist(i));
MN2O(i,1:2) = [LISM.N2O_mean_nmolkg(sM(sMs(1))) LISM.N2O_mean_nmolkg(sM(sMs(end)))];
[~,sMs] = sort(LISM.Depth(sM));
plot(LISM.N2O_mean_nmolkg(sM(sMs)),LISM.Depth(sM(sMs)),'o-');
end;
legend(stnlist);
xlabel('N_2O')
title('May')
...
sA = find(LISA.Station==stnlist(i));
[~,sAs] = sort(LISA.Depth(sA));
plot(LISA.O2_umolkg(sA(sAs)),LISA.Depth(sA(sAs)),'o-');
end;
...
sO = find(LISO.Station==stnlist(i));
[~,sOs] = sort(LISO.Depth(sO));
plot(LISO.O2_umolkg(sO(sOs)),LISO.Depth(sO(sOs)),'o-');
end;
legend(stnlist);
xlabel('O_2')
title('Oct')
...
sM = find(LISM.Station==stnlist(i));
[~,sMs] = sort(LISM.Depth(sM));
plot(LISM.O2_umolkg(sM(sMs)),LISM.Depth(sM(sMs)),'o-');
end;
legend(stnlist);
xlabel('O_2')
title('May')
...
ACH4(:,3) = ACH4(:,1) - ACH4(:,2);
OCH4(:,3) = OCH4(:,1) - OCH4(:,2);
MCH4(:,3) = MCH4(:,1) - MCH4(:,2);


AN2O(:,3) = AN2O(:,1) - AN2O(:,2);
ON2O(:,3) = ON2O(:,1) - ON2O(:,2);
MN2O(:,3) = MN2O(:,1) - MN2O(:,2);
...
%print(gcf, '-dpng', '-r300', '20250712_LIS_Transect_DCH4_DN2O_DO2_PDen_nocolorbar.png');
