...
% O2_offset_drift
cal_times = [datetime(2022,8,4,14,16,0) datetime(2022,8,19,14,11,0)]; % times that cal samples were collected
cal_ratio = [1.03456 1.04405]; % ratio of titrator value/sensor value
...
t_start = datetime(2022,8,5,11,10,0);
t_end = datetime(2022,8,12,11,0,0);
...
plot(xti,T_i_PO);
plot(xti,T_i_SO,'k');
legend('PME', 'PO', 'SO', 'location','eastoutside');
ylabel('temp [^oC]');
axis tight;
ylim([20 29]);
xlim([t_start t_end]);
...
plot(xti,T_i_PO);
plot(xti,T_i_SO,'k');
legend('PME', 'ProOeanus', 'StarOddi', 'location','south');
ylabel('temp [^oC]');
axis tight;
xlim([t_start t_end]);

print -dpng -r300 temp_Aug5_Aug12.png;
...
print -dpng -r300 O2eq_N2eq_Aug5_Aug12.png;

%save O2_N2_Aug5_Aug12.mat xti S_i T_i O2_i N2_i TDGP_i

%%
ts = datetime(2022,8,6,6,0,0);
te = datetime(2022,8,11,6,0,0);
figure(4)
clf; 
x0=10;
y0=10;
...
print -dpng -r300 O2eq_N2eq_Aug5_Aug12_subset.png;
print -dpdf -r300 O2eq_N2eq_Aug5_Aug12_subset.pdf;
print -depsc -r300 O2eq_N2eq_Aug5_Aug12_subset.eps;
