...
t_start = datetime(2022,8,12,12,30,0);
t_end = datetime(2022,8,19,11,0,0);
...
plot(xti,T_i_PO);
plot(xti,T_i_SO,'k');
legend('PME', 'ProOeanus', 'StarOddi', 'location','north');
ylabel('temp [^oC]');
axis tight;
xlim([t_start t_end]);

print -dpng -r300 temp_Aug12_Aug19.png;
...
print -dpng -r300 O2_N2_Aug12_Aug19.png;
